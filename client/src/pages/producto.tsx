...
export default function Producto() {
    ...
    const product = {
        ...
        originalPrice: 8000,
        rating: 5,
        image: "/lapiceros-colores.jpg",
        description: "Lapicero de alta calidad con 10 minas de colores diferentes.",
    }
            ...
            <div className="flex-1 h-full bg-gray-100 py-8 px-4">
                <div className="max-w-7xl h-full mx-auto flex flex-col min-h-0">
                    ...
                    <div className="text-gray-600 font-medium mb-8 bg-white p-4 rounded-lg">
                        Categoría/Producto/Lapicero con 10 minas de colores
                    </div>
                    ...
                    <div className="z-10 grid w-full grid-cols-1 md:grid-cols-5 grid-rows-2 gap-3 h-[60vh]">
                        ...
                        <div className="md:col-span-3 row-span-2 bg-white rounded-lg h-full pt-6 mt-auto">
                            ...
                            <div className="pb-4 px-6 border-b-8 border-gray-100">
                                <h1 className="text-3xl font-bold text-customPurple1">{product.title}</h1>
                            </div>
                                ...
                                <div className="w-3/5 py-6 flex flex-col justify-center items-center relative border-l-8 border-gray-100">
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className="text-center">
                                            <span className="text-4xl font-bold text-customPurple1">${product.price.toLocaleString()}</span>
                                    ...
                                    <button onClick={() => setIsFavorite(!isFavorite)} className="absolute top-5 right-3 text-customPurple1 hover:text-purple-600">
